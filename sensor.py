...
class Camera(Sensor):
    ...
    def __init__(self, config, port, url, host):
        ...
        Log.Write('camera resolution %s - framerate %u' % (str(camera.resolution), camera.framerate))
        ...
        def settings():
            ...
            Log.Write('camera.exposure_speed = %s' % str(camera.exposure_speed))
        ...
        utils.StartThread(settings, restart=False)
